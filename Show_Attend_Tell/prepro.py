...
from core2.vggnet import Vgg19
from core2.utils import *
...
def main():
    ...
    val_cutoff = int(0.1 * len(val_dataset)) #len(val_dataset)
    test_cutoff = int(0.2 * len(val_dataset))  #int(0.2 * len(val_dataset))
